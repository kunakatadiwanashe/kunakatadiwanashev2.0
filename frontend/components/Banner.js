...
const Banner = () => {
    return (
        <div className=" pt-20 pl-5 pr-5 md:pt-0 md:pl-0 md:pr:0 min-h-screen flex flex-col justify-center ">
            <div className="text-center md:text-left md:flex md:items-center md:justify-between mx-auto md:pl-30 md:pr-20">
                ...
                <div className="md:w-1/2">
                    ...
                    <h1 className="text-5xl md:text-5xl font-bold text-[#0668D5;] pb-2">Web Developer +</h1>
                    <h1 className="text-5xl md:text-5xl font-bold text-[#0668D5;]">Ux Designer</h1>

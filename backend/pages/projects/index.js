...
<div className="blogpage">
            ...
            <div className="blogstable">
                <div className="flex gap-2 mb-1">
                    <h2 className="">Search Project</h2>
                    <input
                        type="text"
                        id="id"
                        name="name"
...
<tbody className="">
                        {loading ? <>
                            ...
                            {publishedblogs.length === 0 ? (
                                <tr>
                                    <td colSpan={4} className="text-center">no projects</td>
                                </tr>
                            ) : (
                                    ...
                                    <tr key={blog.id}>
                                        ...
                                        <td>
                                            <div className="flex gap-2 flex-center ">
                                                <Link href={'/blogs/edit' + blog._id}><FaEdit /></Link>
                                                <Link href={'/blogs/delete' + blog._id}><RiDeleteBin2Fill /></Link>
                                            </div>
                                        </td>
                                    </tr>
                                ))
